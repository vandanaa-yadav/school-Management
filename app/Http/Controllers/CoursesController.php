...
class CoursesController extends Controller
{
    ...
    {
        $courses = Course::all(); // Assuming your model name is 'Course' and follows proper naming conventions (capitalized singular form)
        return view('courses.index', ['courses' => $courses]); // Pass 'courses' variable instead of 'student'
    }
